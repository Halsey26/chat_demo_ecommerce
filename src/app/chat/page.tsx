...
export default function ChatPage() {
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-700 via-gray-900 to-black p-4">
      ...
      <div className="mx-auto w-[92%] sm:w-[85%] md:w-[700px]  lg:w-[800px] bg-white/80 backdrop-blur-md shadow-2xl rounded-3xl flex flex-col overflow-hidden border border-gray-300 transition-all duration-300">
        ...
        <div className="flex items-center justify-center border-b border-gray-300 bg-white/60 py-4 px-6">
          <img src="/bot_image.png" alt="Logo" className="h-24 w-auto object-contain" />
        </div>
        ...
        >
          <textarea
            ref={textareaRef}
            className="flex-1 p-2 rounded-lg border border-gray-200 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"
            value={input}
